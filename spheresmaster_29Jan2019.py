...
J_rate = A * np.exp(Balpha3/np.log(omega)**2)/1000/1000/1000/1000*10 * 10000 * 10000
...
#        NUCLEI_3ROW[row,2] = newz3
    ...
    for ones in np.arange(0,y_length*2):
        ...
        for point in grid_range:
            l1 = distanceFormula(surface_points[point,0],surface_points[point,1],surface_points[point,2],surface_points[point+201,0], surface_points[point+201,1], surface_points[point+201,2])
            l2 = distanceFormula(surface_points[point+201,0], surface_points[point+201,1], surface_points[point+201,2], surface_points[point+202,0],surface_points[point+202,1],surface_points[point+202,2])
            l3 = distanceFormula(surface_points[point+202,0],surface_points[point+202,1],surface_points[point+202,2],surface_points[point+1,0], surface_points[point+1,1], surface_points[point+1,2])
            l4 = distanceFormula(surface_points[point+1,0], surface_points[point+1,1], surface_points[point+1,2], surface_points[point,0],surface_points[point,1],surface_points[point,2])            
            #something is up with this - keeps producing nans            
            area_cell = areaofIrregularQuad(l1,l2,l3,l4,surface_points[point,0],surface_points[point,1],surface_points[point,2],surface_points[point+202,0],surface_points[point+202,1],surface_points[point+202,2])
...
#point1 = [[0,0,2]]
#
#tri1 = np.append(point1, point3, axis = 0)
#
#tri1 = np.append(tri1, point2, axis=0)
#
#np.linalg.det(tri1)
