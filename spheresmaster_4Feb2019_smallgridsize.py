...
#    if t == max_t-delta_t:                                                  #save the last timestep image, and this also keeps that plot open
    fig.savefig('/Users/Marta/Documents/Python/nucleation_model_output/plots/modelnucleisphere_om' + str(omega) + '.png')
...
#    plt.pause(.001)    
#    if t == max_t-delta_t:                                                  #save the last timestep image, and this also keeps that plot open
    fig.savefig('/Users/Marta/Documents/Python/nucleation_model_output/plots/modelnucleisurface_om' + str(omega) + '.png')
...
filename = '/Users/Marta/Documents/Python/nucleation_model_output/'+str(omega)+'_nucleationmodelrun'
