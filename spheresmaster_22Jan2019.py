...
#seems reasonable
    ...
    def totalGrowthAnotherWay():
        ...
        for ones in range(y_length):
            ...
            for point in grid_range:
                ...
                point3 = [[surface_points[point+102,0],surface_points[point+102,1],surface_points[point+102,2]]]
                point4 = [[surface_points[point+101,0], surface_points[point+101,1], surface_points[point+101,2]]]   
                point1_list = np.append(point1_list,point1, axis=0)
    ...
    def totalVolume():
        ...
        #Area of the base of the triangular prism is half the area of one flat grid cell (z=0), with an area of 1
        A = 0.5
        Vol_total = 0
        for ones in range(y_length):
...
#
    ...
    if t == max_t-delta_t:                                                  #save the last timestep image, and this also keeps that plot open
        fig.savefig('/Users/Marta/Documents/Python/Plots/modelnucleisphere_om7.png')
...
###plotting the surface of the nuclei   
    ...
    plt.pause(.001)    
    if t == max_t-delta_t:                                                  #save the last timestep image, and this also keeps that plot open
        fig.savefig('/Users/Marta/Documents/Python/Plots/modelnucleisurface_om7.png')
