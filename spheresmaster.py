...
#Start with one nuclei randomly distrubuted on the XY plane. 
    ...
    #n=1.7
        ...
        def unique_file_name(basename, ext):
        ...
        plt1_name = unique_file_name('/Users/Marta/Documents/Python/nucleation_model_output/plots/modelnucleisphere_om' + str(omega) + '_' + str(max_t) + '_',  'png')
        ...
        plt2_name = unique_file_name('/Users/Marta/Documents/Python/nucleation_model_output/plots/modelnucleisurface_om' + str(omega) + '_' + str(max_t) + '_',  'png')
        ...
        filename = unique_file_name('/Users/Marta/Documents/Python/nucleation_model_output/text_files_2/'+str(omega)+'_'+str(max_t)+'_', 'txt')
